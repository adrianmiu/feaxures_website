    ...
    <div class="container-narrow">
      ...
      <div class="row-fluid marketing">
        <div class="span12">
          ...
          <p><strong>Feaxures</strong> attempts to solve these problems (and <a href="faq.php#other">a few others</a>) by recognizing that any feature that is part of a progressive enhancement strategy has the following characteristics:</p>
          <ul>
            ...
            <li><strong>Instantiation</strong>: the code that is run when the feature is applied to an element. It can be as simple as <code>$(this).tabs();</code> or as complex as you can imagine.
          </ul>
          ...
          <p class="alert alert-info">Feaxures JS is MIT licensed... in case you're interested :)</p>
        </div>
